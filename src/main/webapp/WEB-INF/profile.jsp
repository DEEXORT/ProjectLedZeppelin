...
<div class="container">
    ...
    <div class="quest-container" style="margin-top: 0;">
        ...
        <div class="ability-container">
            <!-- Левая колонка - текущие способности -->
            <div>
                <h4>Текущие способности</h4>
                <div class="abilities-grid">
                    <c:forEach var="ability" items="${player.abilities}">
                        <div class="ability-card selected">
                            <input type="checkbox" name="abilityIds" value="${ability.id}" checked class="ability-checkbox">
            ...
            <!-- Правая колонка - выбор новых способностей -->
            <div>
                <h4>Выбрать способности</h4>
                <form action="${pageContext.request.contextPath}/profile" method="post" id="abilities-form">
                    <div class="abilities-grid">
                        <c:forEach var="ability" items="${sessionScope.allAbilities}">
                            <c:if test="${!player.abilities.contains(ability) && ability.levelRequirement <= player.level}">
                                <label class="ability-card">
                                    <input type="checkbox" name="abilityIds" value="${ability.id}" class="ability-checkbox">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        //         e.preventDefault();
        //         alert('Можно выбрать не более 3 способностей!');
        //     }
        // });
