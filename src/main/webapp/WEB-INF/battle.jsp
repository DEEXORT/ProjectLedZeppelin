...
<div class="quest-container">
    ...
    <div class="card">
        ...
        <c:if test="${requestScope.action == 'throwDice'}">
            <p><b>Случайное событие</b></p>
            <p>Вы наткнулись на монстра! <br>
                Победите его!</p>
        ...
        <c:if test="${requestScope.action == 'left'}">
            <p>Вы победили!</p>
            <form action="${pageContext.request.contextPath}/quest?sceneId=${sessionScope.player.questSceneId}" method="get">
                <button type="submit" class="btn btn-quest">
                    Пойти дальше
                </button>
            </form>
